...
public final class ActivityBridDogWorkoutBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityBridDogWorkoutBinding(@NonNull ConstraintLayout rootView,
  ...
  @NonNull
  public static ActivityBridDogWorkoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBridDogWorkoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_brid_dog_workout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBridDogWorkoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBridDogWorkoutBinding((ConstraintLayout) rootView, overallCountTextView,
